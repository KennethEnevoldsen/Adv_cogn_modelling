...
for (x in 1:n_part){
  ...
  res[[x]] <- pos_pred_check(true_val = choices[[x]], 
                 data_to_fit = list(choice = choices[[x]],
                                    ...
                                    n_trials = length(choices[[x]]), n_decks =4), 
                 probability_param = "p", 
